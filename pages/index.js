  ...
  return (
    <div className="h-screen bg-gradient-to-r from-rose-700 to-pink-600">
      <div className="flex flex-col items-center justify-center">
        ...
        {/* Image */}
        <div className="pt-16 my-10 animate-bounce">
